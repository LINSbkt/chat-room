...
class LoginDialog(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        base_dir = os.path.dirname(os.path.dirname(
            os.path.abspath(__file__)))  # -> m/src/client/gui
    ...
    def setup_ui(self):
        ...
        self.username_input.setPlaceholderText(
            "Username (1-20 characters, alphanumeric + spaces, _, -)")
        ...
        self.username_input.textChanged.connect(
            self.validate_username_realtime)
    ...
    def validate_username_final(self, username: str) -> bool:
        ...
        if not all(c in allowed_chars for c in username):
            QMessageBox.warning(
                self, "Invalid Username", "Username contains invalid characters. Only letters, numbers, spaces, underscores, and hyphens are allowed.")
            return False
