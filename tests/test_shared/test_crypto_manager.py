...
class TestCryptoManager(unittest.TestCase):
    ...
    def test_rsa_encrypt_decrypt(self):
        ...
        encrypted = self.crypto.encrypt_with_rsa(
            original_data, self.crypto.rsa_public_key)
    ...
    def test_aes_encrypt_unicode(self):
        ...
        self.crypto.generate_aes_key()
        original_text = "Hello! Encryption test"
    ...
    def test_encrypt_aes_key_with_rsa(self):
        ...
        encrypted_key = self.crypto.encrypt_aes_key_with_rsa(
    ...
    def test_decrypt_aes_key_with_rsa(self):
        ...
        encrypted_key = self.crypto.encrypt_aes_key_with_rsa(
            self.crypto.rsa_public_key)
        decrypted_key, decrypted_iv = self.crypto.decrypt_aes_key_with_rsa(
            encrypted_key)
    ...
    def test_full_encryption_workflow(self):
        ...
        encrypted_aes_key = sender.encrypt_aes_key_with_rsa(
